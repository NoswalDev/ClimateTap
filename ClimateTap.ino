...
// void pot2vals(){
//   //convert potentiometer values to fake inputs
//   newAnalog = analogRead(A0);
//   if (maxAnalog <= newAnalog){
//     maxAnalog = newAnalog + 2;
//     Fan_Multi = maxAnalog / Fan_Steps;
//   }
//   fan_stat = newAnalog / Fan_Multi;
//   newAnalog = analogRead(A1);
//   if (maxAnalog <= newAnalog){
//     maxAnalog = newAnalog + 2;
//     Temp_Multi = maxAnalog / (Temp_High - Temp_Low);
//   }
//   temp_stat = newAnalog / Temp_Multi + Temp_Low;
// }